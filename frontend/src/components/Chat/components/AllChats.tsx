...
// Sample data for all chats
const allChats: { username: string; message: string; profileImage: string; messageStatus: MessageStatus; time: string }[] = [
    {
        username: 'Ashwin',
    ...
    },
    {
        ...
        profileImage: 'https://picsum.photos/seed/neha/100',
        messageStatus: 'sent',
        time: '10:45'
    },
    {
        ...
        profileImage: 'https://picsum.photos/seed/ankit/100',
        messageStatus: 'received',
        time: '11:15'
    },
    {
        ...
        profileImage: 'https://picsum.photos/seed/simran/100',
        messageStatus: 'viewed',
        time: '11:45'
    },
    {
        ...
        profileImage: 'https://picsum.photos/seed/manish/100',
        messageStatus: 'sent',
        time: '12:00'
    },
    {
        username: 'Raj',
        message: 'Let’s discuss the new features.',
        profileImage: 'https://picsum.photos/seed/raj/100',
        messageStatus: 'received',
        time: '12:30'
    }
];
    ...
    return (
        <div className="px-4 py-2 border-b border-neutral-700">
            <div className="flex items-center space-x-2">
                <Icon icon="ant-design:message-twotone" className="text-neutral-400" width="20" height="20" />
                <h3 className="text-sm font-bold">All Chats</h3>
            </div>

            <ScrollArea className="h-[calc(3*5.2rem)] mt-2">
                <div className="space-y-2 mr-3">
                    {allChats.map((chat, index) => (
                        <div key={index} className="flex items-center p-2 bg-neutral-800 hover:bg-neutral-700 transition-colors duration-200 rounded-lg !cursor-pointer !hover:cursor-pointer">
